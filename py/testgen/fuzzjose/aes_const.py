...
# This Python implementation is derived from Go crypto/aes/const.go,
...
# (polynomials over GF(2)) modulo the irreducible polynomial x^128 + x^4 + x^3
# + x + 1.
# Addition of these binary polynomials corresponds to binary xor.
# Reducing mod poly corresponds to binary xor with poly every
# time a 0x100 bit appears.
poly = 1 << 8 | 1 << 4 | 1 << 3 | 1 << 1 | 1 << 0
