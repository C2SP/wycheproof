...
var TESTS_TO_RUN_CHROME = goog.cloneObject(TESTS_ALL);

// Tests to run on Firefox
var TESTS_TO_RUN_FIREFOX = goog.cloneObject(TESTS_ALL);

// Tests to run on MS Edge.
// MS Edge doesn't support ECDSA and ECDH
var TESTS_TO_RUN_EDGE = goog.cloneObject(TESTS_ALL);
TESTS_TO_RUN_EDGE[TEST_ECDSA_VECTORS] = false;
TESTS_TO_RUN_EDGE[TEST_ECDSA_BIAS] = false;
TESTS_TO_RUN_EDGE[TEST_ECDH_VECTORS] = false;
